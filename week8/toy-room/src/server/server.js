...
const privateKey = fs.readFileSync(path.resolve(__dirname, 'privatekey.pem')).toString();
const certificate = fs.readFileSync(path.resolve(__dirname, 'certificate.pem')).toString();
